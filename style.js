	...
	edito_demoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Lista ordenada9', element: 'ol', attributes: { 'class': 'bck-ol bck-ol9' } },
				{ name: 'Lista ordenada10', element: 'ol', attributes: { 'class': 'bck-ol bck-ol10' } },
				{ name: 'Lista ordenada11', element: 'ol', attributes: { 'class': 'bck-ol bck-ol11' } },
				{ name: 'Lista ordenada12', element: 'ol', attributes: { 'class': 'bck-ol bck-ol12' } },
